...
from .const import DEFAULT_MOTION_INTERVAL, DEFAULT_MOTION_OFF_DELAY, DEFAULT_SCAN_INTERVAL, DOMAIN, CONF_SCAN_INTERVAL, CONF_MOTION_INTERVAL, CONF_PTZ_ENABLED
...
class Hi3510DataCoordinator(DataUpdateCoordinator[dict[str, Any]]):
    ...
    async def _async_update_data(self) -> dict[str, Any]:
        ...
        # PTZ supportato se abilitato nelle opzioni o nei dati config
        data["ptz_supported"] = (
            self.config_entry.options.get(CONF_PTZ_ENABLED, False)
            or self.config_entry.data.get(CONF_PTZ_ENABLED, False)
        )
